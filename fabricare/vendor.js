...
runInPath("archive", function() {
	webLink = "https://gitlab.gnome.org/GNOME/libxml2/-/archive/v"+Project.version+"/libxml2-v"+Project.version+".tar.gz";
	...
	Shell.rename("libxml2-v"+Project.version,"libxml2-"+Project.version);
